...
public class GuiChat extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        animate = RenderingUtils.progressiveAnimation(animate, this.width - 2, 0.6);
        drawRect(2, this.height - 14, animate, this.height - 2, Integer.MIN_VALUE);

        if (Echo.INSTANCE.getAddonManager().getAddon("cchat").isState())
            RenderingUtils.drawRectangle(2, this.height - 14, 3.5f, this.height - 2, Echo.INSTANCE.getClientColor());

        this.inputField.drawTextBoxCustom();
        IChatComponent ichatcomponent = this.mc.ingameGUI.getChatGUI().getChatComponent(Mouse.getX(), Mouse.getY());
